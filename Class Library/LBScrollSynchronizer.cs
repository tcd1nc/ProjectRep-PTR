...
namespace PTR
{
    public class ScrollSynchronizer : DependencyObject
    {
        ...
        private static void Scroll(ScrollViewer changedScrollViewer)
       {
        ...
        public static bool GetLeftBtnClicked (DependencyObject obj)
        {
            return (bool)obj.GetValue(LeftBtnClickedProperty);
        }

        public static void SetLeftBtnClicked(DependencyObject obj, bool value)
        {
            obj.SetValue(LeftBtnClickedProperty, value);
        }

        public static readonly DependencyProperty LeftBtnClickedProperty = DependencyProperty.RegisterAttached("LeftBtnClicked", typeof(bool),
            typeof(ScrollSynchronizer), new PropertyMetadata(new PropertyChangedCallback(LeftButtonClicked)));
  
        private static void LeftButtonClicked (DependencyObject d, DependencyPropertyChangedEventArgs args)
        {
        ...
        public static bool GetRightBtnClicked(DependencyObject obj)
        {
            return (bool)obj.GetValue(RightBtnClickedProperty);
        }

        public static void SetRightBtnClicked(DependencyObject obj, bool value)
        {
            obj.SetValue(RightBtnClickedProperty, value);
        }

        public static readonly DependencyProperty RightBtnClickedProperty = DependencyProperty.RegisterAttached("RightBtnClicked", typeof(bool),
            typeof(ScrollSynchronizer), new PropertyMetadata(new PropertyChangedCallback(RightButtonClicked)));


        private static void RightButtonClicked(DependencyObject d, DependencyPropertyChangedEventArgs args)
        {
            if (!(bool)args.NewValue) return;
        ...
        private static void ScrollLeft()
        {
            ...
            {
                if (scrollViewer.Key.HorizontalOffset > 0)                
                    scrollViewer.Key.ScrollToHorizontalOffset(scrollViewer.Key.HorizontalOffset - 1);                
            }
        }
        ...
        private static void ScrollRight()
        {
            foreach (var scrollViewer in scrollViewers)
            {
                if (scrollViewer.Key.ScrollableWidth > 0)                
                    scrollViewer.Key.ScrollToHorizontalOffset(scrollViewer.Key.HorizontalOffset + 1);                
            }
        }
