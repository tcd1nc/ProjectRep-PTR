        ...
        private void ReportGrid_AutoGeneratingColumn(object sender, DataGridAutoGeneratingColumnEventArgs e)
        {
            try
            {
                ...
                if (ds.Tables[ctr].Columns[colname].ExtendedProperties.ContainsKey("FieldType")
                            && (int)ds.Tables[ctr].Columns[colname].ExtendedProperties["FieldType"] != (int)ReportFieldType.SystemAndHidden
                            && (int)ds.Tables[ctr].Columns[colname].ExtendedProperties["FieldType"] != (int)ReportFieldType.SystemAndRemoved)
                {
